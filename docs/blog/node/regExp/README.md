...
<h5>视频链接地址（视频格式可按需增删） 例如: http://www.abc.com/video/wc.avi</h5>
...
<h5>图片链接地址（图片格式可按需增删） 例如: https://www.abc.com/logo.png</h5>

```js{0}
/^https?:\/\/.*?(?:gif|png|jpg|jpeg|webp|svg|psd|bmp|tif)$/i
```

<h5>网址  例如: www.qq.com</h5>

```js{0}
/^(?:(?:https?|ftp):\/\/)?(?:[\da-z.-]+)\.(?:[a-z.]{2,6})(?:\/\w\.-]*)*\/?/
```
<h5>邮箱地址 例如: 90203918@qq.com, nbilly@126.com</h5>
...
<h5>数字/货币金额 (只支持正数、不支持校验千分位分隔符)</h5>
...
<h5>银行卡号（10到30位, 覆盖对公/私账户, 参考[微信支付]</h5>
...
```
<h5>中国手机号(严谨), 根据工信部2019年最新公布的手机号段</h5>
...
<h5>中国手机号(宽松), 只要是13,14,15,16,17,18,19开头即可</h5>
...
<h5>二代身份证号(18位数字),最后一位是校验位,可能为数字或字符X</h5>
...
<h5>帐号是否合法(字母开头，允许5-16字节，允许字母数字下划线组合</h5>
...
<h5>密码强度正则，最少6位，包括至少1个大写字母，1个小写字母，1个数字，1个特殊字符</h5>
...
<h5>用户名正则，4到16位（字母，数字，下划线，减号）</h5>
...
<h5>微信号，6至20位，以字母开头，字母，数字，减号，下划线</h5>
